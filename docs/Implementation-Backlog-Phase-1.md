...
| `startedAt` | — |
| `owner` | — |
| `notes` | Текущая задача ещё не назначена. Рекомендуемый старт: `P1-011`. |
...
- После закрытия `P1-010` следующий рекомендуемый шаг — `P1-011`: реализовать компилятор топологии (`topology compiler`) с трансляцией `endpointId` в станции, сервисные точки, узлы и привязки ресурсов.
