...
| `startedAt` | — |
| `owner` | — |
| `notes` | Текущая задача ещё не назначена. Рекомендуемый старт: `P1-022`. |
...
- После закрытия `P1-021` следующий рекомендуемый шаг — `P1-022`: реализовать materializer `CarrierTransfer` в режиме `SHUTTLE_RIDES_HYBRID_LIFT_WITH_PAYLOAD`.
