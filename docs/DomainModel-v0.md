...
**Последнее обновление:** 2026-04-04<br>
...
11. `CarrierTransfer` планируется в `WES` как макрошаг, а внутренние фазы исполнения `BoardCarrier` / `MoveCarrier` / `ExitCarrier` материализуются только внутри `WCS`.
